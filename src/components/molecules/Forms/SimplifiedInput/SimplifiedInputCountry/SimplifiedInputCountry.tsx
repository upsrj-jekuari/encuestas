  ...
  return (
    <SimplifiedInputTemplate title={title}>
      <label
        ...
        className="relative flex h-12 w-full items-center rounded transition-all hover:shadow-lg bg-neutral-200 hover:outline hover:outline-1 hover:outline-neutral-200 hover:bg-transparent px-4 "
      >
        <ReactCountryFlag
        ...
        />
        <span className="ml-4">
          {countryListAllIsoData.find((country) => {
...
export default SimplifiedInputCountry;
